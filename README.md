...
Content
This public dataset of 5,856 X-Ray images is provided by Mendeley data. The dataset is organized into 3 folders (train, test, val) and contains subfolders for each image category (Pneumonia/Normal). The  pneumonia are a labeled mix of bacterial or viral. 
...
The model then predicted that this image contains pneumonia with .1% certainty, meaning that it is most likely a normal/ healthy xray.
